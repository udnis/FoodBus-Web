...
if(isset($_GET['user_id'])){
    ...
    $requests = "SELECT food_id,donor_id,time,date,name,amount_claimed,amount_got,claim_request,approved,declined,id FROM food_details_receiver WHERE user_id = {$id} AND declined = 1";
